...
// void AuthService::registerUser(const TcpConnectionPtr &conn,const json &js, int tmpid)
// {
//     User user;
...
// void AuthService::buildLoginInfo(const TcpConnectionPtr &conn,const json &js, User &user, bool loginbytoken)
// {
